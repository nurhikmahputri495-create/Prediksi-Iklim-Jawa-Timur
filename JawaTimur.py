...
SHEET_NAME = "Data Harian - Table"  # ganti jika beda
...
# Rename kolom yang sering berbeda
...
st.subheader("📅 Data Harian (input)")
st.dataframe(df.head(20))

# ================================
# 2. VARIABEL IKLIM YANG DIPAKAI
# ================================
possible_vars = [
...
full_plot = []
for var in available_vars:
    hist = monthly_df[['Tahun','Bulan',var,'Sumber']] \
            .rename(columns={var:'Nilai'})
    hist['Variabel'] = label[var]

    pred = future[['Tahun','Bulan',f'Pred_{var}','Sumber']] \
            .rename(columns={f'Pred_{var}':'Nilai'})
